...
async function sendWebhook(systemInfo, options = {}) {
	const webhookUrl = process.env.SYSTEM_INFO_WEBHOOK_URL;
	const webhookToken = process.env.SYSTEM_INFO_WEBHOOK_TOKEN;
	const webhookEnabled = process.env.SYSTEM_INFO_WEBHOOK_ENABLED || false; // 默认禁用
