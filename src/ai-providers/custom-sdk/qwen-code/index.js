...
import {QwenCodeLanguageModel} from './language-model.js';
...
export function createClaudeCode(options = {}) {
	 ...
	 * @returns {QwenCodeLanguageModel}
	 */
	const createModel = (modelId, settings = {}) => {
		return new QwenCodeLanguageModel({
			id: modelId,
			settings: {
 ...
 */
export const qwenCode = createClaudeCode();

// Provider exports
export { QwenCodeLanguageModel } from './language-model.js';
